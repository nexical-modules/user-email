...
export const GET = defineApi(
  async (context, actor) => {
    ...
    const result = await UserEmailService.list({ where, take, skip, orderBy, select }, actor);
    ...
    // Analytics Hook
    await HookSystem.dispatch('userEmail.list.viewed', {
      count: data.length,
...
export const POST = defineApi(
  async (context, actor) => {
    ...
    const result = await UserEmailService.create(validated, select, actor);
